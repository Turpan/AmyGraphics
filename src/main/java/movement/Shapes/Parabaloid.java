...
//CURRENTLY THIS IS JUST NOT WORKING. NEED TO REWORK THE WHOLE THING, REALLY... I THINK A BETTER SOLUTION WOULD BE TO JUST MAKE TWO
//PARABOLAS, s.t. THEY're thickness distance away at the peak, and fit into the box otherwise created. More of an... arc thing, than a other thing. 
// or maybe I'll just only make the normal point out... Interesting...

//ALSO, with rotation, I kinda don't need to do this the way that I have.
